...
BASE_URL  = "https://www.promofarma.com.br"                 # storefront (product_url); Cloudflare-WAF blocks datacenter IPs
API_HOST  = "https://promofarma.vtexcommercestable.com.br"  # VTEX backend host — bypasses the storefront WAF (used for all catalog API calls)
STORE_ID  = "promofarma"
